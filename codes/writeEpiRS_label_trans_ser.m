...
gxPre = mr.makeTrapezoid('x',sys,'Area',-gx.area/4);
gxPre2 = mr.makeTrapezoid('x',sys,'Area',-gx.area/2);
gyPre = mr.makeTrapezoid('y',sys,'Area',Ny_pre*deltak);
[gxPre,gyPre,gzReph]=mr.align('right',gxPre,'left',gyPre,gzReph);
gzReph2=gzReph;
[gxPre2,gzReph2]=mr.align('right',gxPre2,gzReph2);
